...
resource "openstack_compute_instance_v2" "instance" {
  depends_on  = [module.floating_ip, module.network, module.security_group, module.volume, module.flavor]
  name        = var.instance_name
  flavor_name = module.flavor.flavor_info.name

  security_groups = [
    for sg in module.security_group.security_group_list : sg["id"]
  ]
  network {
